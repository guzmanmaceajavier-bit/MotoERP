              ...
              <div className="rounded-xl border border-amber-200 bg-amber-50 px-4 py-3 text-amber-800">
                ...
                {user ? (
                  ...
                  <>
                    ...
                    {workshop_phone && (
                      <a
                        href={`https://wa.me/${workshop_phone}?text=${encodeURIComponent(`Hola, realicé una transferencia por el pedido ${done.invoice_number} por un valor de $${done.total.toLocaleString('es-CO')}. Adjunto el comprobante de pago.`)}`}
                        target="_blank"
